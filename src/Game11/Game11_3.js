...
// var song = null;
export default class Game11_3 extends React.Component {
    constructor(props) {
        super(props);
    ...
    hideIma2(){
        ...
        this.props.navigation.navigate("Game11_4")
    }
    getMyStyle2() {
                    ...
                    <View style={styles.main}>
                        <TouchableOpacity
                            ...
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle1()} source={require('../img/11/chim.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            ...
                            style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle2()} source={require('../img/11/conca.png')}></Image>
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
