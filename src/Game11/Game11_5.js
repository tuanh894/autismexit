...
// var song = null;
export default class Game11_5 extends React.Component {
    constructor(props) {
        super(props);
    ...
    hideIma1(){
        ...
        this.props.navigation.navigate("Game11_6")
    }
    getMyStyle1() {
                    ...
                    <View style={styles.main}>
                        <TouchableOpacity
                            ...
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle1()} source={require('../img/11/hopsua.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            ...
                            style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle2()} source={require('../img/11/daugoi.png')}></Image>
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
