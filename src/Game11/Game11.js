...
// var song = null;
export default class Game11 extends React.Component {
    constructor(props) {
        super(props);
    ...
    hideIma2(){
        ...
        this.props.navigation.navigate("Game11_1")
    }
    getMyStyle2() {
                    ...
                    <View style={styles.main}>
                        <TouchableOpacity
                            ...
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle1()} source={require('../img/11/tao.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            ...
                            style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle2()} source={require('../img/11/ga.png')}></Image>
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
