...
export default class Game11_6 extends React.Component {
    constructor(props) {
        super(props);
    ...
    hideIma4(){
        ...
        this.props.navigation.navigate("Game11_7")
                    ...
                    <View style={styles.main}>
                        <TouchableOpacity
                            ...
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle1()} source={require('../img/6/meo.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity
                            ...
                            style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle2()} source={require('../img/6/lon.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity
                            ...
                            style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle3()} source={require('../img/6/chuot.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity
                        ...
                        <TouchableOpacity
                            ...
                            style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle5()} source={require('../img/6/chim.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity
                            ...
                            style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle6()} source={require('../img/6/ga.png')}></Image>
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
