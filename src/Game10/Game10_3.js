...
// var song = null;
export default class Game10_3 extends React.Component {
    constructor(props) {
        super(props);
    ...
    hideIma1(){
        ...
        this.props.navigation.navigate("Game10_4")
                    ...
                    <View style={styles.main}>
                        ...
                        <TouchableOpacity
                            ...
                            <View style={styles.mainImgView}>
                                ...
                                <Image style={this.getMyStyle7()} source={require('../img/10/keo_tim.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity
