...
export default class Game5_4 extends React.Component {
    constructor(props) {
        super(props);
                    ...
                    <View style={styles.main}>
                        <TouchableOpacity
                            ...
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle1()} source={require('../img/4/meo.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity
                            ...
                            style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle2()} source={require('../img/4/chim.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity
                        ...
                        <TouchableOpacity
                            ...
                            style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle4()} source={require('../img/4/meo.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity
                            ...
                            style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle5()} source={require('../img/4/meo.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity
                            ...
                            style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle6()} source={require('../img/4/meo.png')}></Image>
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
