...
export default class Game6_1 extends React.Component {
    constructor(props) {
        super(props);
        this.state ={
            status1:false,
                ...
                <View style={styles.view}>
                    ...
                    <View style={styles.main}>
                        ...
                        <TouchableOpacity onPress={() => this.hideIma3()} style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle3()} source={require('../img/6/ga.png')}></Image>
                            </View>
                        </TouchableOpacity>
                    ...
                    <View style={styles.main}>
                        ...
                        <TouchableOpacity onPress={() => this.hideIma9()} style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle9()} source={require('../img/6/duahau.png')}></Image>
                            </View>
                        </TouchableOpacity>
