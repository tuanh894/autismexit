                    ...
                    <View style={styles.main}>
                        <TouchableOpacity onPress={() => this.hideIma1()} style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle1()} source={require('../img/8/hinhtamgiac.png')}></Image>
                            </View>
                        </TouchableOpacity>

                        <TouchableOpacity onPress={() => this.hideIma2()} style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle2()} source={require('../img/8/hinhtron.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity onPress={() => this.hideIma4()} style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle4()} source={require('../img/8/hinhchunhat.png')}></Image>
                            </View>
                        </TouchableOpacity>

                        <TouchableOpacity onPress={() => this.hideIma5()} style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle5()} source={require('../img/8/hinhtron.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.hideIma6()} style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle6()} source={require('../img/8/hinhtron.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.hideIma7()} style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle7()} source={require('../img/8/hinhthoi.png')}></Image>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.main}>
                        <TouchableOpacity onPress={() => this.hideIma8()} style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle8()} source={require('../img/8/hinhtron.png')}></Image>
                            </View>
                        </TouchableOpacity>

                        <TouchableOpacity onPress={() => this.hideIma9()} style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle9()} source={require('../img/8/hinhtron.png')}></Image>
                            </View>
                        </TouchableOpacity>

                        <TouchableOpacity onPress={() => this.hideIma10()} style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle10()} source={require('../img/8/hinhtron.png')}></Image>
                            </View>
                        </TouchableOpacity>

                        <TouchableOpacity onPress={() => this.hideIma11()} style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle11()} source={require('../img/8/hinhtron.png')}></Image>
                            </View>
                        </TouchableOpacity>

                        <TouchableOpacity onPress={() => this.hideIma12()} style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle12()} source={require('../img/8/hinh_lucgiac.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.hideIma13()} style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle13()} source={require('../img/8/hinhtron.png')}></Image>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.hideIma14()} style={styles.mainItem}>
                            <View style={styles.mainImgView}>
                                <Image style={this.getMyStyle14()} source={require('../img/8/hinhtron.png')}></Image>
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
